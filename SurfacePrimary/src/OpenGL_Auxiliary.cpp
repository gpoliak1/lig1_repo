...
GLfloat ctrlpoints_D[4][4][4] =
		{
				{ { 1.13000, 0.00000, 0.00000, 1 }, { 0.75300, 1.26593, 0.00000,
						1 }, { 1.89882, 2.39460, 0.00000, 1 }, { 0.00000,
						3.00000, 0.00000, 1 } }, //y
				{ { 0, 0, 0, 1 }, { 0, 1, 0, 1 }, { 0, 2, 0, 1 }, { 0, 3, 0, 1 } },
				{ { 0, 0, 0, 1 }, { 0, 1, 0, 1 }, { 0, 2, 0, 1 }, { 0, 3, 0, 1 } },
				{ { 0, 0, 0, 1 }, { 0, 1, 0, 1 }, { 0, 2, 0, 1 }, { 0, 3, 0, 1 } } //x
		};
//C
GLfloat ctrlpoints_C[4][4][4] =
		{ { { 0.00000, 2.60000, 0.00000, 1 }, { 0.49206, 2.87619, 0.00000, 1 },
				{ 0.56085, 2.95661, 0.00000, 1 },
				{ 1.00000, 3.00000, 0.00000, 1 } }, //y
				{ { 0, 0, 0, 1 }, { 0.333, 0, 0, 1 }, { 0.667, 0, 0, 1 }, { 1,
						0, 0, 1 } }, { { 0, 0, 0, 1 }, { 0.333, 0, 0, 1 }, {
						0.667, 0, 0, 1 }, { 1, 0, 0, 1 } }, { { 0, 0, 0, 1 }, {
						0.333, 0, 0, 1 }, { 0.667, 0, 0, 1 }, { 1, 0, 0, 1 } } //x
		};
...
//	GLfloat *ptr[1];
//	ptr[0] = &ctrlpoints_C[0][0][0];
//	GLfloat *points = ptr[0];

	masterCtrl[0] = &ctrlpoints_C[0][0][0];
	masterCtrl[1] = &ctrlpoints_D[0][0][0];
}
